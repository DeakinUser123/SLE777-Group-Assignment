...
```{r}
seqinr::count(unlist(cds_ecoli),1) # Counts how many times the value '1' occurs in the unlisted coding sequences of E. coli
sum(seqinr::count(unlist(cds_ecoli),1)) # Calculates the total of '1' occurrences in the unlisted E. coli coding sequences
```

b. C. baratii

```{r}
seqinr::count(unlist(cds_Cbaratii),1)  # Counts how many times the value '1' occurs in the unlisted coding sequences of C. baratii
sum(seqinr::count(unlist(cds_Cbaratii),1)) # Calculates the total of '1' occurrences in the unlisted C. baratii coding sequences.
```
